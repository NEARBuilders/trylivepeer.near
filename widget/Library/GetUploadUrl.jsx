...
return (
  <Container>
    ...
    <div>
      ...
      <DescriptionContent>
        This component accepts an asset name and provides the upload URLs
        required for asset uploads, as well as generating a playback ID
        essential for the
        ...
        component for standard uploads via a single URL. For more robust
        uploads, especially in conditions of slow connectivity, use the
